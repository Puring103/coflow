...
4. 修改后先运行 `coflow check <project>`；需要产物时再运行 `coflow codegen <project>`。
...
- 项目 pipeline、check/codegen 阶段：读 `references/project-pipeline.md`，公开链接 <https://puring103.github.io/coflow/docs/reference/02-project-pipeline>。
