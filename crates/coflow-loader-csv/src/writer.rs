...
use coflow_api::{
    ...
    DimensionSourceManager, DimensionSourceManagerDescriptor, DimensionSourceRequest,
    DimensionSourceResult, InsertRecordRequest, RecordOrigin, RenameRecordRequest,
    RewriteRecordReferencesRequest, SourceDocument, SourceLocationSpec, SyncHeaderRequest,
    TableContext, TableManager, TableManagerDescriptor, TableOperationResult, WriteCellRequest,
...
pub static CSV_DIMENSION_SOURCE_MANAGER_DESCRIPTOR: DimensionSourceManagerDescriptor =
