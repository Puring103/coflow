...
impl CftErrorCode {
    ...
    const fn entry(self) -> (CftStage, &'static str) {
        match self {
            ...
            Self::MultipleIdFieldsInTree => (CftStage::Schema, "CFT-SCHEMA-013"),
            ...
            Self::RefTargetMustBeType => (CftStage::Schema, "CFT-SCHEMA-027"),
            ...
            Self::RefTargetHasNoId => (CftStage::Schema, "CFT-SCHEMA-032"),
            Self::RefIdTypeMismatch => (CftStage::Schema, "CFT-SCHEMA-033"),
