...
pub enum CftErrorCode {
    ...
    SingletonKeyAsEnumConflict,
    SingletonNotReferenceable,
    UnknownValueName,
    UnknownField,
...
impl CftErrorCode {
    ...
    const fn entry(self) -> (CftStage, &'static str) {
        match self {
            ...
            Self::KeyAsEnumRequiresEmptyEnum => (CftStage::Schema, "CFT-SCHEMA-027"),
            ...
            Self::SingletonKeyAsEnumConflict => (CftStage::Schema, "CFT-SCHEMA-037"),
            Self::SingletonNotReferenceable => (CftStage::Schema, "CFT-SCHEMA-038"),
