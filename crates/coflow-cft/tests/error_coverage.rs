...
fn cases() -> Vec<Case> {
    vec![
        ...
        Case {
            name: "localized bucket not identifier",
            phase: Phase::Compile,
            source: r#"type A { @localized("not an ident") name: string; }"#,
        ...
        Case {
            name: "singleton with keyAsEnum",
            phase: Phase::Compile,
            source: "@singleton @keyAsEnum(AKey) type A {} enum AKey {}",
            adjacent_valid_source: "@keyAsEnum(AKey) type A {} enum AKey {}",
            codes: &[CftErrorCode::SingletonKeyAsEnumConflict],
        },
        Case {
