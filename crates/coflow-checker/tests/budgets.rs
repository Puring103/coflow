...
fn expression_depth_limit_stops_the_current_record_with_a_stable_diagnostic() {
    ...
    let err = run_checks_with_options(&CompiledSchema::new(&schema), &model, options(3, 100, 100))
    ...
    run_checks_with_options(&CompiledSchema::new(&schema), &model, options(16, 100, 100))
...
fn nested_data_traversal_uses_the_same_depth_contract() {
    ...
    let err = run_checks_with_options(&CompiledSchema::new(&schema), &model, options(2, 100, 100))
...
fn quantifier_work_limit_points_at_the_first_rejected_item() {
    ...
    let err = run_checks_with_options(&CompiledSchema::new(&schema), &model, options(100, 100, 6))
...
fn aggregate_builtins_charge_work_before_scanning() {
    ...
    let err = run_checks_with_options(&CompiledSchema::new(&schema), &model, options(100, 100, 3))
...
fn aggregate_conversion_charges_nodes_before_copying_items() {
    ...
    let err = run_checks_with_options(&CompiledSchema::new(&schema), &model, options(100, 3, 100))
