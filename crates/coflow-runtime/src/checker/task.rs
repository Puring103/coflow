use crate::data_model::CfdRecordId;
use coflow_language::{CftSchema, CheckStatementId, DimensionName, VariantName};
...
pub struct CheckLimits {
    pub structure: coflow_language::limits::StructuralLimits,
    pub max_tasks: usize,
...
impl Default for CheckLimits {
    fn default() -> Self {
        Self {
            structure: coflow_language::limits::StructuralLimits::default(),
            max_tasks: 1_000_000,
