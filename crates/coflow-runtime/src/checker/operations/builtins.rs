pub(crate) use coflow_language::CftCheckBuiltin as Builtin;

use coflow_language::{CftSchemaCheckExpr, CftSchemaCheckExprKind};
...
use coflow_language::{CftSchema, EnumName};
...
use crate::data_model::{CfdDataModel, CfdErrorCode};
        ...
        Builtin::Intersects | Builtin::IsDisjoint => {
            ...
            'outer: for left_index in 0..left_items.len() {
                ...
                for right_index in 0..right_items.len() {
                    budget
                        .charge_work(coflow_language::limits::StructureKind::CheckEvaluation, 1)
                        .map_err(|error| {
                            OpsError::new(
...
struct ArrayValues<'a> {
    items: &'a EvalItems,
    element_type: Option<&'a coflow_language::CftValueType>,
