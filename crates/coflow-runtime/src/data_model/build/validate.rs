...
impl<'s, 'schema> Validator<'s, 'schema> {
    ...
    pub(super) fn validate_materialized_value(
        ...
        match crate::data_model::semantics::validate_value_for_schema(
            self.schema.cft(),
            &context,
            request,
        ) {
