...
enabled:bool;\n\
    ...
    let previously_broken = "table Product {\n\n  @label(\"Name\")\n  name: string;\n\n  @label(\"Price\")\n\n  price: int;\n\n  @label(\"Enabled\")\n\n  enabled: bool;\n}\n";
    let repaired = "table Product {\n\n  @label(\"Name\")\n  name: string;\n\n  @label(\"Price\")\n  price: int;\n\n  @label(\"Enabled\")\n  enabled: bool;\n}\n";
...
calculate(- 1)!=- 1;    # keep  comment\n\
    ...
    let expected = "table Item : Base {\n  idRef: Item;\n  tags: [string];\n  lookup: {string: int};\n\n  @label(\"Display Name\")\n  @description(\"Shown in editor\")\n  name: string;\n\n  enabled: bool;\n\n  calculate: fn(value: int) -> int;\n\n  check {\n    enabled && calculate(10) >= 10;\n    calculate(-1) != -1; # keep  comment\n  }\n}\n";
    assert_eq!(format_cft(source), expected);
    assert_eq!(format_cft(expected), expected);

    assert_eq!(
        format_cft("table Box {\nvalue:{int: string}?;\ncheck { a>b; c<d; }\n}"),
        "table Box {\n  value: {int: string}?;\n\n  check {\n    a > b;\n    c < d;\n  }\n}\n"
    );
    assert_eq!(
        format_cft("type Callback=fn(value:int)->int?;"),
