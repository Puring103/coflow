...
<div class="flow">
  ...
  <div class="flow-arrow">↓</div>
  <div class="flow-step"><strong>coflow-runtime</strong> 编译 schema、resolve/load source、构建 data model、运行 check 并收集诊断。</div>
  <div class="flow-arrow">↓</div>
...
- [项目架构](/docs/reference/12-architecture)：作为技术参考说明 crate 边界和 runtime 数据流。
