...
- `coflow-engine` owns the runtime implementation: schema compilation, source resolve/load, data model, check, diagnostics, and source/record/file indexes.
- `coflow-runtime` is the host-facing runtime boundary for the CLI, editor, and automation hosts.
