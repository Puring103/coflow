...
use coflow_project::ProjectDiff;
...
fn project_input_kind(kind: &str) -> Result<coflow_project::ProjectInputKind, EditorError> {
    match kind {
        "schema" => Ok(coflow_project::ProjectInputKind::Schema),
        "data" => Ok(coflow_project::ProjectInputKind::Data),
