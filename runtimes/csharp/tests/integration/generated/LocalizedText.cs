...
internal @LocalizedText(Projection value) : base(value) { value.RequireContract(global::@Game.@Config.Generated.ContractIdentity); }
...
internal static readonly Func<Projection,RuntimeDimension<string?>> F1 = v => new RuntimeDimension<string?>(v, v1 => ValueCodecs.OptionalReference(v1, ValueCodecs.String));
}
internal static global::@Game.@Config.@LocalizedText Wrap(Projection value) {
