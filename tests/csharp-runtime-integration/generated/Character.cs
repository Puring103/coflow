...
internal static readonly Func<RuntimeValue,global::@Game.@Config.@Stats> F1 = global::@Game.@Config.@Stats.Wrap;
internal static readonly Func<RuntimeValue,global::@Game.@Config.@Character?> F2 = v0 => ValueCodecs.OptionalReference(v0, global::@Game.@Config.@Character.Wrap);
internal static readonly Func<RuntimeValue,RuntimeDictionary<bool,string>> F3 = v0 => new RuntimeDictionary<bool,string>(v0, ValueCodecs.Bool, ValueCodecs.String);
internal static readonly Func<RuntimeValue,RuntimeDictionary<global::@Game.@Config.@Mood,string>> F4 = v0 => new RuntimeDictionary<global::@Game.@Config.@Mood,string>(v0, v1 => (global::@Game.@Config.@Mood)ValueCodecs.Enum(v1), ValueCodecs.String);
internal static readonly Func<RuntimeValue,global::@Game.@Config.@Mood?> F5 = v0 => ValueCodecs.OptionalValue(v0, v1 => (global::@Game.@Config.@Mood)ValueCodecs.Enum(v1));
internal static readonly Func<RuntimeValue,global::@Game.@Config.@Stats?> F6 = v0 => ValueCodecs.OptionalValue(v0, global::@Game.@Config.@Stats.Wrap);
internal static readonly Func<RuntimeValue,RuntimeArray<string>?> F7 = v0 => ValueCodecs.OptionalReference(v0, v1 => new RuntimeArray<string>(v1, ValueCodecs.String));
internal static readonly Func<RuntimeValue,RuntimeFunction<int>?> F8 = v0 => ValueCodecs.OptionalReference(v0, v1 => new RuntimeFunction<int>(v1, ValueCodecs.IntInvocation));
internal static readonly Func<RuntimeValue,RuntimeTemplate> F9 = v => new RuntimeTemplate(v);
internal static readonly Func<RuntimeValue,RuntimeFunction<int,int>> F10 = v0 => new RuntimeFunction<int,int>(v0, ValueCodecs.IntInvocation, ValueCodecs.IntInvocation);
internal static readonly Func<RuntimeValue,RuntimeFunction<global::@Game.@Config.@Character,global::@Game.@Config.@Character>> F11 = v0 => new RuntimeFunction<global::@Game.@Config.@Character,global::@Game.@Config.@Character>(v0, ValueCodecs.RuntimeInvocation<global::@Game.@Config.@Character>(global::@Game.@Config.@Character.Wrap), ValueCodecs.RuntimeInvocation<global::@Game.@Config.@Character>(global::@Game.@Config.@Character.Wrap));
internal static readonly Func<RuntimeValue,RuntimeFunction<RuntimeArray<RuntimeFunction<int>>,RuntimeArray<RuntimeFunction<int>>>> F12 = v0 => new RuntimeFunction<RuntimeArray<RuntimeFunction<int>>,RuntimeArray<RuntimeFunction<int>>>(v0, ValueCodecs.RuntimeInvocation<RuntimeArray<RuntimeFunction<int>>>(v2 => new RuntimeArray<RuntimeFunction<int>>(v2, v3 => new RuntimeFunction<int>(v3, ValueCodecs.IntInvocation))), ValueCodecs.RuntimeInvocation<RuntimeArray<RuntimeFunction<int>>>(v2 => new RuntimeArray<RuntimeFunction<int>>(v2, v3 => new RuntimeFunction<int>(v3, ValueCodecs.IntInvocation))));
internal static readonly Func<RuntimeValue,RuntimeFunction<RuntimeTemplate,RuntimeTemplate>> F13 = v0 => new RuntimeFunction<RuntimeTemplate,RuntimeTemplate>(v0, ValueCodecs.TemplateInvocation, ValueCodecs.TemplateInvocation);
internal static readonly Func<RuntimeValue,RuntimeFunction<global::@Game.@Config.@Stats,global::@Game.@Config.@Stats>> F14 = v0 => new RuntimeFunction<global::@Game.@Config.@Stats,global::@Game.@Config.@Stats>(v0, ValueCodecs.RuntimeInvocation<global::@Game.@Config.@Stats>(global::@Game.@Config.@Stats.Wrap), ValueCodecs.RuntimeInvocation<global::@Game.@Config.@Stats>(global::@Game.@Config.@Stats.Wrap));
internal static readonly Func<RuntimeValue,RuntimeFunction<int,RuntimeFunction<int>>> F15 = v0 => new RuntimeFunction<int,RuntimeFunction<int>>(v0, ValueCodecs.IntInvocation, ValueCodecs.RuntimeInvocation<RuntimeFunction<int>>(v2 => new RuntimeFunction<int>(v2, ValueCodecs.IntInvocation)));
}
