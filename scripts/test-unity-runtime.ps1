...
Copy-Item -Path "$repo/runtimes/csharp/Coflow.Runtime/src/*.cs" -Destination "$project/Assets/Runtime" -Force
Copy-Item -Path "$repo/tests/csharp-runtime-integration/generated/*.cs" -Destination "$project/Assets/Generated" -Force
Copy-Item -LiteralPath "$repo/tests/csharp-runtime-integration/generated/coflow.contract" -Destination "$project/Assets/Resources/coflow.bytes" -Force
Copy-Item -LiteralPath "$repo/target/release/coflow_ffi.dll" -Destination "$project/Assets/Plugins/x86_64/coflow_ffi.dll" -Force
Copy-Item -LiteralPath "$repo/tests/unity-runtime-smoke/CoflowSmoke.cs" -Destination "$project/Assets/CoflowSmoke.cs" -Force
Copy-Item -LiteralPath "$repo/tests/unity-runtime-smoke/Editor/SmokeBuild.cs" -Destination "$project/Assets/Editor/SmokeBuild.cs" -Force
