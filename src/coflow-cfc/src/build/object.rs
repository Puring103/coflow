...
impl BuildCtx<'_> {
    ...
    fn eval_named_in_object_state(
            ...
            .contains_key(&(target_module.clone(), target_name.clone()))
        {
            ...
            let branches = union
                ...
                .collect::<Vec<_>>();
            let value = self.eval_union_in_object_state(
                module,
                default_module,
                &target_module,
                expr,
            ...
            return Some(self.wrap_union_value(&target_module, &target_name, value));
        }
    ...
    fn eval_union_in_object_state(
        ...
        match &expr.kind {
            ...
            | ExprKind::Float(_)
            | ExprKind::Array(_)
            | ExprKind::Dict(_) => self.eval_union_literal_in_object_state(
                module,
                default_module,
                branch_scope,
                expr,
    ...
    fn eval_union_literal_in_object_state(
        &mut self,
        module: &ModuleId,
        default_module: &ModuleId,
        branch_scope: &ModuleId,
