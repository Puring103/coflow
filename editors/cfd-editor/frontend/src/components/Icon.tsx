...
const PATHS: Record<IconProps['name'], string> = {
  ...
  'graph':         'M5 3h4a2 2 0 012 2v4a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2zM15 13h4a2 2 0 012 2v4a2 2 0 01-2 2h-4a2 2 0 01-2-2v-4a2 2 0 012-2zM7 11v4a2 2 0 002 2h4',
