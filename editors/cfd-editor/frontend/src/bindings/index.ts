...
export type RecordRow = { key: string; actual_type: string; file_path: string; fields: FieldCell[]; spread_fields: string[]; spread_sources: SpreadSource[]; is_fallback: boolean };
