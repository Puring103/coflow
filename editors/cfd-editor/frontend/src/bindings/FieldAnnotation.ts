 ...
 */
description?: string, enum_int_value: bigint | null, declared_type: string | null, ref_target_type: string | null, enum_type: string | null, enum_is_flag: boolean, nullable: boolean,
/**
