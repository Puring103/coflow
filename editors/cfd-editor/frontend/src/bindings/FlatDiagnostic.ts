 ...
 */
export type FlatDiagnostic = { severity: string, code: string, stage: string, message: string, file_path: string | null, record_key: string | null, field_path: string | null, };
