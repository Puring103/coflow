...
- TextMate syntax highlighting plus LSP semantic tokens for namespaces, imports, declarations, annotations, Option/Result values, function types and bodies, strings, numbers, operators, references, and built-ins.
- Language configuration for comments, brackets, indentation, and auto-closing pairs.
- Snippets for namespaces/imports, declarations, checks, Option/Result values, function types and values, and supported annotations.
