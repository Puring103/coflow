...
cargo run --manifest-path "$repo_dir/Cargo.toml" -- codegen "$repo_dir/engine/runtimes/csharp/tests/integration"
"$dotnet_path" run -c Release --project "$benchmark_dir/Coflow.Runtime.Benchmarks.csproj" -- "$@"
