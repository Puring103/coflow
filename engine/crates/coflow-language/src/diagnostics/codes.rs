...
impl CftErrorCode {
    ...
    const fn entry(self) -> (CftStage, &'static str) {
        match self {
            ...
            Self::InvalidTypeReference => (CftStage::Schema, "CFT-SCHEMA-044"),
            ...
            Self::TypeAliasCycle => (CftStage::Schema, "CFT-SCHEMA-040"),
            Self::RequiredObjectCycle => (CftStage::Schema, "CFT-SCHEMA-042"),
            Self::DefaultMaterializationCycle => (CftStage::Schema, "CFT-SCHEMA-043"),
